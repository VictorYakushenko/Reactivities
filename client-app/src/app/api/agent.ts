...
const requests = {
    ...
    post: <T, Y>(url: string, body: Y) => axios.post<T>(url, body).then(responseBody),
    put: <T, Y>(url: string, body: Y) => axios.put<T>(url, body).then(responseBody),
...
const Activities = {
    ...
    attend: (id: string) => requests.post<void, object>(`/activities/${id}/attend`, {})
}
...
const Account = {
    ...
    refreshToken: () => requests.post<User, object>('/account/refreshToken', {})
}
